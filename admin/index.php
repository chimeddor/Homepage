...
<?php
    if(isset($_POST['submit'])){
      ...
      foreach($query as $row){
        ...
        $name = $row['username'];
        $phone = $row['password'];
        if($username == $name and $password == $phone){
          header ('Location: admin.php');
        }else{
          echo "<script>alert('check password and username')</script>";
        }
