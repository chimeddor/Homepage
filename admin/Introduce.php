...
<?php
  ...
  <?php
    if(isset($_POST['delete'])){
      $id = $_POST['delete'];
      echo $id;
      $delete = mysqli_query($connect,"DELETE FROM introduction WHERE id = '".$id."' ");
    ...
    <div class="panel-group" data-as-sortable="vm.documentDragListeners" ng-model="vm.documents">
      <div class="panel panel-default xlist" ng-repeat="doc in vm.documents"  data-as-sortable-item>        
        <div id="collapse{{$index}}" class="panel-collapse collapse in">
            <form  action="introduce.php" method="POST"  enctype="multipart/form-data" >
            ...
            ?>
                <tr>
                    ...
                    <td>
                      <textarea name="intro1"  class="form-control"  placeholder="필수" aria-describedby="inputGroup-sizing-sm" cols="200" rows="1.8"  disabled><?= $r['intro1']?></textarea>
                  </td>
                </tr>
                <tr>
                <td class="text-center email">Introduction2</td>
                    <td><textarea name="intro2"  class="form-control" placeholder="필수" aria-describedby="inputGroup-sizing-sm"  cols="100" rows="7" disabled ><?= $r['intro2']?></textarea></td>
                  </td>
                  </tr>
               <tr>
                <td colspan="2" class="text-center">
                  <div>
                   ...
                   <button   class="btn btn-primary" id="update" name="update"  value="<?= $r['id']?>" style="width: 120px; border:none; background-color:#F5F5F5; color:black" ><?php echo '<a href="introduce_update.php?name='.$newid.'">Edite</a>'?></button>
