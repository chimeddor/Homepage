...
<?php
  ...
  if(isset($_POST['update'])){
    ...
    // $file = $_FILES['image']['name'];
      $upd = mysqli_query($connect,"UPDATE research_areas SET  research_text = '".$hha."', research_title = '".$tit."' WHERE id = '".$ids."' ");
      if($upd){
        ...
        <div id="collapse{{$index}}" class="panel-collapse collapse in">
            ...
            ?>
                <tr>
                    ...
                    <td>
                      <textarea name="titles"  class="form-control"  placeholder="필수" aria-describedby="inputGroup-sizing-sm" cols="200" rows="1.8" ><?= $r['research_title']?></textarea>
                  </td>
                </tr>
                <tr>
                <td class="text-center email">Text</td>
                    <td><textarea name="reastext"  class="form-control" placeholder="필수" aria-describedby="inputGroup-sizing-sm"  cols="100" rows="7" ><?= $r['research_text']?></textarea></td>
                  </td>
                  </tr>
               <tr>
