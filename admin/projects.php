...
<body ng-controller="demoController as vm">
  ...
  if(isset($_POST['upload'])){
    ...
    $file = $_FILES['image']['name'];
      ...
      $insert = mysqli_query($connect,"INSERT INTO projects(project_name,a_little_introduction,Contents,project_image, data_time) VALUES('".$projectname."','".$little."','".$cont."','$file',now())");
          ...
          <br>
            ...
            <table class="table table-bordered table-sm" id="table1" style="display: block;">
                ...
                <tr>
                    ...
                    <td><textarea name="proname"  class="form-control"  placeholder="필수" aria-describedby="inputGroup-sizing-sm" cols="200" rows="1.8"></textarea></td>
                </tr>
                <tr>
                <td class="text-center email">Little Introduction</td>
                    <td><textarea name="introduction"   class="form-control" placeholder="필수" aria-describedby="inputGroup-sizing-sm" cols="200" rows="1.8"></textarea></td>
                </tr>
                <tr>
                <td class="text-center phone">Conent</td>
                    <td><textarea name="con"  class="form-control" placeholder="필수" aria-describedby="inputGroup-sizing-sm" cols="100" rows="2"></textarea></td>
                </tr>
                <tr>
                ...
                <tr><td colspan="2" class="text-center"><input type="submit" style="width: 120px;" name="upload" class="btn btn-primary" value="upload"></td></tr>
                </tbody>
            </table>
